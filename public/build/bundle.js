...
var app = (function () {
    ...
    /* src/routes/Home.svelte generated by Svelte v3.16.7 */
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$2, 8, 2, 160);
    			add_location(div, file$2, 11, 2, 206);
    		},
    		m: function mount(target, anchor) {
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$4, safe_not_equal, { url: 0 });
