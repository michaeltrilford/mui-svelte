import path, { extname, sep, resolve, join } from 'path';
...
function ensureArray(thing) {
    if (Array.isArray(thing))
        return thing;
    if (thing == undefined)
        return []; // eslint-disable-line no-undefined, eqeqeq
    return [thing];
}
...
function getMatcherString(id, resolutionBase) {
    ...
    var basePath = typeof resolutionBase === 'string' ? resolve(resolutionBase) : process.cwd();
    for (var _i = 0, ESCAPE_IN_PATH_1 = ESCAPE_IN_PATH; _i < ESCAPE_IN_PATH_1.length; _i++) {
        var char = ESCAPE_IN_PATH_1[_i];
